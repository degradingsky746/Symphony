...
?>
    ...
    <div id="mainBackground">
        ...
        <div id="headingtext" >
            <h1 class="animated fadeIn delay-1s">Get great music,<br>right now</h1>
            <h2 class="animated fadeIn delay-1s">Platform for streaming music for free</h2>
                <!-- <ul class="animated rollIn delay-2s">
                    <li><img src="./assets/images/icons/heart.png" width=25> Discover music you'll fall in love with</li>
