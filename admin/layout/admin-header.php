...
<nav>
    <div class="nav-wrapper white lighten-5">
        <div class="container">
      <a href="dashboard.php" class="brand-logo grey-text center"> <span class="red-text">Symphony</span>  -ADMIN panel</a>
  ...
  <ul id="slide-out" class="sidenav">
        ...
        <a href="settings.php"><img class="circle" src="../assets/images/profile-pics/admin.png"></a>
