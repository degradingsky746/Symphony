...
class Account {
    ...
    private function registerNewUser($userName,$firstName,$lastName,$email,$password){
        ...
        $result = mysqli_query($this->con," INSERT INTO users (username,firstName,lastName,email,password,signUpDate,profilePic)  VALUES ('$userName','$firstName','$lastName','$email','$newPassword','$signUpDate','$profilePic')");
        return $result;
     }
