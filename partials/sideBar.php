<div id="sideBarContainer">
            <nav class="navBar">
                <span   tabindex="0" role="link" onclick="openPage('index.php')"  class="logo"><img src="./assets/images/logo2.png"  alt=""></span>

                <div class="Elements">
                    <div class="navItem">
                    <span   tabindex="0" role="link" onclick="openPage('search.php')" class="navLink">Search... <img src="./assets/images/icons/searchcs.png" alt=""> </a>
                    </div>
                </div>
